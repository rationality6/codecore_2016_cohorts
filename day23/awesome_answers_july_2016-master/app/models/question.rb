class Question < ApplicationRecord
  ...
  #this will give us handy methods to easily created associated answers ApplicationRecordfetch assciated answers as well. note that it should be pluralized format# one to many asociation.
  ...
  validates :title, uniqueness: {scope: [scope: :body]}
