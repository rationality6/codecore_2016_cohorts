Rails.application.routes.draw do
  ...
  resources :questions do
    # # collection is used when we don't
    # need to specify a particular question
    # # but we expect a collection of
    # # question. Examples: index / create
    #
    # post :search, on: :collection
    #
    # # member is used when we need to
    # # identify a particular question.
    # # Examples: index / create
    #
    # post :search, on: :member
    #
    # # This is when we want to have nested
    # # routes for out resources. Example:
