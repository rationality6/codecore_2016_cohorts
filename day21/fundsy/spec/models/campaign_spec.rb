...
RSpec.describe Campaign, type: :model do
  describe "Validations" do
    # we can use `it` mehtod (or specify) to define a test example. The method
    # takes a first arguement which is the example description and it takes a
    ...
    it "requires a unique title" do
      # GIVEN: a campaign created in the DB with a title. New campaign with the
      #        the same title
